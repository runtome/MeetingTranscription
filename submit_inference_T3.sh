...
#SBATCH -J Infer_T3		# Specify job name
#SBATCH -o output_inferance_T3.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T3.csv --model ./whisper-thai-finetuned-t3
