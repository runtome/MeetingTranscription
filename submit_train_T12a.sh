...
#SBATCH -J T12a		# Specify job name
#SBATCH -o output_train_T12a.txt		# Specify output file name with job ID
...
srun  python finetune_whisper.py \
    ...
    --output_dir ./whisper-thai-finetuned-t12a \
    --epochs 10 --learning_rate 5e-6 --augment --freeze_encoder
