...
#SBATCH -J In_T13		# Specify job name
#SBATCH -o output_inferance_T13.txt		# Specify output file name with job ID
...
srun   python inference_whisper_hf.py \
    --model ./whisper-thai-finetuned-t13 \
    --output results/results_T13.csv
