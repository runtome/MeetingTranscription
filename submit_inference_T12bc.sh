...
#SBATCH -J In_T12bc		# Specify job name
#SBATCH -o output_inferance_T12bc.txt		# Specify output file name with job ID
...
srun  python inference_whisper_hf.py \
    --model ./whisper-thai-finetuned-t12b \
    --output results/results_T12bc_clean.csv --clean
