...
#SBATCH -J Train_T7		# Specify job name
#SBATCH -o output_train_T7.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-large-v3-turbo --output_dir ./whisper-thai-finetuned-t7 --epochs 50
