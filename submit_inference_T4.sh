...
#SBATCH -J Infer_T4		# Specify job name
#SBATCH -o output_inferance_T4_org.txt		# Specify output file name with job ID
...
srun python inferance_original.py --output results_train_T4_original.csv --model ./whisper-thai-finetuned-t4
