...
#SBATCH -J Train_T9		# Specify job name
#SBATCH -o output_train_T9.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-large-v3 --output_dir ./whisper-thai-finetuned-t9 --epochs 20
