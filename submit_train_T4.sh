...
#SBATCH -J Train_T4		# Specify job name
#SBATCH -o output_train_T4.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-large-v3-turbo --output_dir ./whisper-thai-finetuned-t4 --epochs 10
