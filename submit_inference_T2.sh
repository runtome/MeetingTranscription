...
#SBATCH -J Infer_T2		# Specify job name
#SBATCH -o output_inferance_T2.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T2.csv --model ./whisper-thai-finetuned
