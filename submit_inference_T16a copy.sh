...
#SBATCH -J In_T16a		# Specify job name
#SBATCH -o output_inferance_T16a.txt		# Specify output file name with job ID
...
srun   python inference_whisper_hf.py \
    --model ./whisper-thai-finetuned-t16a \
    --output results/results_T16a.csv
