...
#SBATCH -J TrainT10		# Specify job name
#SBATCH -o output_train_T10.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name typhoon-ai/typhoon-whisper-large-v3 --output_dir ./whisper-thai-finetuned-t10 --epochs 20
