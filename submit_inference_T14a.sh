...
#SBATCH -J In_T14a		# Specify job name
#SBATCH -o output_inferance_T14a.txt		# Specify output file name with job ID
...
srun   python inference_whisper_hf.py \
    --model ./whisper-thai-finetuned-t14a \
    --output results/results_T14a.csv
