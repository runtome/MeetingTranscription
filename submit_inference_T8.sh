...
#SBATCH -J Inf_T8		# Specify job name
#SBATCH -o output_inferance_T8.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T8.csv --model ./whisper-thai-finetuned-t8
