...
#SBATCH -J Train_T5		# Specify job name
#SBATCH -o output_train_T5.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-medium --output_dir ./whisper-thai-finetuned-t5 --epochs 20
