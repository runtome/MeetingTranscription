...
#SBATCH -J T15		# Specify job name
#SBATCH -o output_train_T15.txt		# Specify output file name with job ID
...
srun  python finetune_whisper.py \
    --model_name typhoon-ai/typhoon-whisper-turbo \
    --output_dir ./whisper-thai-finetuned-t15 \
    --epochs 10 --augment
