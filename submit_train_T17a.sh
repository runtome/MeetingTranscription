...
#SBATCH -J T17a		# Specify job name
#SBATCH -o output_train_T17a.txt		# Specify output file name with job ID
...
srun  python finetune_whisper.py \
    --model_name typhoon-ai/monsoon-whisper-medium-gigaspeech2 \
    --output_dir ./whisper-thai-finetuned-t17a \
    --epochs 15 --augment
