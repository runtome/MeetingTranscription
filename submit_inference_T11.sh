...
#SBATCH -J Inf_T11		# Specify job name
#SBATCH -o output_inferance_T11.txt		# Specify output file name with job ID
...
srun python inference_whisper_hf.py \
  --model ./whisper-thai-finetuned-t11 \
  --test_dir test \
  --output results/results_train_T11.csv
