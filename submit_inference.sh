...
#SBATCH -J Inferance		# Specify job name
#SBATCH -o output_inferance.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train.csv --model openai/whisper-large-v2 
