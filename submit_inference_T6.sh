...
#SBATCH -J Infer_T6		# Specify job name
#SBATCH -o output_inferance_T6.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T6.csv --model ./whisper-thai-finetuned-t6
