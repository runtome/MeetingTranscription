...
#SBATCH -J Inf_T10		# Specify job name
#SBATCH -o output_inferance_T10.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T10.csv --model ./whisper-thai-finetuned-t10
END=`date`
endtime=$(date +%s)
