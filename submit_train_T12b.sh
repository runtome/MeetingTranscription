...
#SBATCH -J T12b		# Specify job name
#SBATCH -o output_train_T12b.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py \
    --model_name typhoon-ai/typhoon-whisper-large-v3 \
    --output_dir ./whisper-thai-finetuned-t12b \
    --epochs 10 --learning_rate 5e-6 --augment --encoder_lr_factor 0.1
