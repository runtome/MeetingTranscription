...
#SBATCH -J Infe_T6V		# Specify job name
#SBATCH -o output_inferance_T6_valSet.txt		# Specify output file name with job ID
...
srun python inference_whisper.py \
  --model ./whisper-thai-finetuned-t6 \
  --test_dir ./val/audio \
  --output ./val/annotation/inferance_T6_val.csv
