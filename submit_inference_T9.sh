...
#SBATCH -J Infer_T9		# Specify job name
#SBATCH -o output_inferance_T9.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T9.csv --model ./whisper-thai-finetuned-t9
END=`date`
endtime=$(date +%s)
