...
#SBATCH -J Train_T2		# Specify job name
#SBATCH -o output_train_T2.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-large-v3 --epochs 10
