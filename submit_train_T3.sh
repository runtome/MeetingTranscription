...
#SBATCH -J Train_T3		# Specify job name
#SBATCH -o output_train_T3.txt		# Specify output file name with job ID
...
srun python finetune_whisper.py --model_name openai/whisper-base --output_dir ./whisper-thai-finetuned-t3 --epochs 20
