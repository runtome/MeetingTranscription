...
#SBATCH -J Infer_T7		# Specify job name
#SBATCH -o output_inferance_T7.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T7.csv --model ./whisper-thai-finetuned-t7
