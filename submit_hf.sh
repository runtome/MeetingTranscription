...
#SBATCH -J HF_PT_T2		# Specify job name
#SBATCH -o output_hf_T2.txt		# Specify output file name with job ID
...
srun python inference_whisper_hf.py --output results_hg_T2.csv
