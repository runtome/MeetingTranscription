...
#SBATCH -J Infe_T4T		# Specify job name
#SBATCH -o output_inferance_T4_TrainSet.txt		# Specify output file name with job ID
...
srun python inferance_original.py \
  --output results_train_T4_original.csv \
  --model ./whisper-thai-finetuned-t4 \
  --test_dir ./train/audio \
  --output ./train/inferance_T4.csv
