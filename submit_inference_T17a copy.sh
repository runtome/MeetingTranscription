...
#SBATCH -J In_T17a		# Specify job name
#SBATCH -o output_inferance_T17a.txt		# Specify output file name with job ID
...
srun   python inference_whisper_hf.py \
    --model ./whisper-thai-finetuned-t17a \
    --output results/results_T17a.csv
