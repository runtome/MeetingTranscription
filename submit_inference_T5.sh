...
#SBATCH -J Infer_T5		# Specify job name
#SBATCH -o output_inferance_T5.txt		# Specify output file name with job ID
...
srun python inference_whisper.py --output results_train_T5.csv --model ./whisper-thai-finetuned-t5
